...
| **Asset naming** | **Three conventions coexisting**: `env_mp_beacon`, `env_tut_gantry`, `prop-fortress-wall`, `mech-craton-x`, `int-cockpit` | One namespace `vp_<domain>_<biome>_<name>_<variant>_<lod>` | PIPELINE §3.3 |
